...
this, and it is the single most important test in the repo — if it goes red, stop and fix it
before anything else. It is the tripwire for the entire testing strategy.
