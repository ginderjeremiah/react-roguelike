...
4. **A style that never opens the shutter must not out-earn one that flashes.** Light has to have a
   product darkness cannot buy, or the wager has only one side.
...
at least once before re-dormanting.** Near 0 and the pursuit is theatre; near 1 and 8 is too long. The
**8 is the dial.** A distance requirement is not, and the change log says why the fix §4 used to name
was rejected.
