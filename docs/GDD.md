...
> over 2000 seeds through `openRun`: **223, or 11.2%**. Per depth over 400 floors each: floor 1
> **9.5%**, rising to **~21%** on floors 6-8 — so the 20% is the deep-arrival rate. The repository
